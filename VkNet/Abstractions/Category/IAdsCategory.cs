...
public interface IAdsCategory : IAdsCategoryAsync
{
	...
	ReadOnlyCollection<CreateCampaignResult> CreateCampaigns(
	...
	ReadOnlyCollection<CreateClientResult> CreateClients(
	...
	ReadOnlyCollection<GetTargetGroupsResult> GetTargetGroups(long accountId, long? clientId = null,
        bool? extended = null);
	...
	SaveLookALikeRequestResultResult SaveLookalikeRequestResult(
	...
	ReadOnlyCollection<UpdateAdsResult> UpdateAds(
	...
	ReadOnlyCollection<UpdateCampaignsResult> UpdateCampaigns(
	...
	ReadOnlyCollection<UpdateClientsResult> UpdateClients(
	...
	ReadOnlyCollection<UpdateOfficeUsersResult> UpdateOfficeUsers(
