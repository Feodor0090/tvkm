...
public interface IVideoCategory : IVideoCategoryAsync
{
	...
	VkCollection<VideoAlbum> GetAlbums(long? ownerId = null, long? offset = null, long? count = null,
        bool? extended = null,
	...
	bool EditComment(long commentId, string message, long? ownerId = null,
	...
	bool RemoveFromAlbum(long ownerId, long videoId, IEnumerable<string> albumIds, long? targetId = null,
        long? albumId = null);
	...
	ReadOnlyCollection<VideoCatalogItem> GetCatalogSection(string sectionId, string from, long? count = null,
        bool? extended = null);
