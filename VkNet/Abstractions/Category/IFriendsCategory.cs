...
public interface IFriendsCategory : IFriendsCategoryAsync
{
    ...
    bool EditList(long listId, string name = null, IEnumerable<long> userIds = null,
    ...
    AddFriendStatus Add(long userId, string text = "", bool? follow = null, long? captchaSid = null,
    ...
    VkCollection<User> GetSuggestions(FriendsFilter filter = null, long? count = null, long? offset = null,
