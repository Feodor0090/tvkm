...
public interface IVideoCategoryAsync
{
	...
	/// </remarks>
	Task<VkCollection<VideoAlbum>> GetAlbumsAsync(long? ownerId = null, long? offset = null, long? count = null,
        bool? extended = null,
	...
	/// </remarks>
	Task<bool> EditCommentAsync(long commentId, string message, long? ownerId = null,
	...
	/// </remarks>
	Task<bool> ReportAsync(long videoId, ReportReason reason, long? ownerId, string comment = null,
	...
	/// </remarks>
	Task<VkCollection<ulong>> AddToAlbumAsync(long ownerId, long videoId, IEnumerable<string> albumIds,
