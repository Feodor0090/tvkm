...
public interface INotificationsCategoryAsync
{
	...
	/// </remarks>
	Task<NotificationGetResult> GetAsync(ulong? count = null, string startFrom = null,
	...
	///     error (object) — в случае, если статус отправки имеет значение false, дополнительно вернётся объект ошибки,
	///     содержащий код ошибки в поле code (integer) и описание description (string).
