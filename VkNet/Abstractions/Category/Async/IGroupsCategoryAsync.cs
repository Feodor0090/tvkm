...
public interface IGroupsCategoryAsync
{
	...
	/// </remarks>
	Task<ReadOnlyCollection<GroupMember>> IsMemberAsync(string groupId, long? userId, IEnumerable<long> userIds,
        bool? extended,
        bool skipAuthorization = false);
	...
	/// </remarks>
	Task<VkCollection<User>> GetInvitedUsersAsync(long groupId, long? offset = null, long? count = null,
    ...
    /// </remarks>
    Task<Group> CreateAsync(string title, string description = null, GroupType type = null,
    ...
    /// </remarks>
    Task<VkCollection<User>> GetRequestsAsync(long groupId, long? offset = null, long? count = null,
        UsersFields fields = null);
