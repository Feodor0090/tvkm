...
public interface IDownloadedGamesCategoryAsync
{
	...
	/// <returns>
	///     В случае успеха возвращает объект с полем is_paid, которое может принимать значения true (если пользователь купил
	///     игру) или false (если пользователь игру не покупал));
	/// </returns>
	/// <remarks>
