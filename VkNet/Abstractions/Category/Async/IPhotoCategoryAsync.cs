...
public interface IPhotoCategoryAsync
{
	...
	/// </remarks>
	Task<UploadServerInfo> GetChatUploadServerAsync(ulong chatId, ulong? cropX = null, ulong? cropY = null,
    ...
    /// </remarks>
    Task<ReadOnlyCollection<Photo>> SaveWallPhotoAsync(string response, ulong? userId, ulong? groupId = null,
        string caption = null);
    ...
    /// </remarks>
    Task<bool> EditCommentAsync(ulong commentId, string message, long? ownerId = null,
