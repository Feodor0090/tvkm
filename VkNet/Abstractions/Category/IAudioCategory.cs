...
public interface IAudioCategory : IAudioCategoryAsync
{
	...
	AudioPlaylist CreatePlaylist(long ownerId, string title, string description = null,
	...
	bool EditPlaylist(long ownerId, int playlistId, string title, string description = null,
        IEnumerable<string> audioIds = null);
	...
	IEnumerable<Audio> GetPopular(bool onlyEng = false, AudioGenre? genre = null, uint? count = null,
        uint? offset = null);
