...
public interface IPhotoCategory : IPhotoCategoryAsync
{
	...
	UploadServerInfo GetChatUploadServer(ulong chatId, ulong? cropX = null, ulong? cropY = null,
	...
	ReadOnlyCollection<Photo> SaveWallPhoto(string response, ulong? userId, ulong? groupId = null,
        string caption = null);
	...
	bool EditComment(ulong commentId, string message, long? ownerId = null,
