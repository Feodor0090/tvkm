...
public interface IDatabaseCategory : IDatabaseCategoryAsync
{
	...
	VkCollection<Country> GetCountries(bool? needAll = null, IEnumerable<Iso3166> codes = null, int? count = null,
        int? offset = null);
    ...
    VkCollection<University> GetUniversities(int countryId, int cityId, string query = "", int? count = null,
        int? offset = null);
    ...
    VkCollection<MetroStation> GetMetroStations(ulong cityId, int? offset = null, int? count = null,
        bool extended = false);
}