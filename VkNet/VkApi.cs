...
/// </summary>
public class VkApi : IVkApiInvoke
{
...
#pragma warning restore S1104 // Fields should not have public accessibility
    ...
    public string Invoke(string methodName, IDictionary<string, string> parameters, bool skipAuthorization = false)
    {
        ...
        var url = $"{_apiServer}/method/{methodName}";
    ...
    public void Authorize(IApiAuthParams @params)
    {
        ...
        if (@params.IsTokenUpdateAutomatically) OnTokenExpires += OnTokenExpired;
    ...
    public int RequestsPerSecond
    {
        ...
        set
        {
            ...
            if (_requestsPerSecond == 0) return;
    ...
    /// <inheritdoc />
    public IStorageCategory Storage { get; private set; }

    /// <inheritdoc />
    public INotificationsCategory Notifications { get; private set; }

    /// <inheritdoc />
    public IPrettyCardsCategory PrettyCards { get; private set; }
    ...
    {
        if (!parameters.ContainsKey(Constants.Version)) parameters.Add(Constants.Version, VkApiVersion.Version);

        if (!parameters.ContainsKey(Constants.AccessToken)) parameters.Add(Constants.AccessToken, AccessToken);
