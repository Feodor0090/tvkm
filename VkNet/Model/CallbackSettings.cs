...
public class CallbackSettings
{
    ...
    public static CallbackSettings FromJson(VkResponse response)
    {
        return new CallbackSettings
        {
            ...
            MessageEdit = response["message_edit"],
            MessageAllow = response["message_allow"],
            MessageDeny = response["message_deny"],
            MessageTyping = response["message_typing_state"],
            ...
            PhotoCommentRestore = response["photo_comment_restore"],
            ...
            VideoCommentRestore = response["video_comment_restore"],
            ...
            WallReplyRestore = response["wall_reply_restore"],
            ...
            MarketCommentDelete = response["market_comment_delete"],
            MarketCommentRestore = response["market_comment_restore"],
            ...
            GroupChangeSettings = response["group_change_settings"],
            ...
            VkPayTransaction = response["vkpay_transaction"],
            VkAppEvent = response["app_payload"]
        };
    }
    ...
    ///     платёж через Vk Pay
    /// </summary>
    [JsonProperty("vkpay_transaction")]
