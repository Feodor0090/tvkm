...
public class Mention
{
	...
	public static Mention FromJson(VkResponse response)
    {
        var mention = new Mention
        {
            ...
            Likes = response["likes"], Comments = response["comments"], Attachment = response["attachment"],
            Geo = response["geo"], CopyOwnerId = response["copy_owner_id"], CopyPostId = response["copy_post_id"],
            ToId = response["to_id"], PostId = response["post_id"], PostType = response["post_type"],
