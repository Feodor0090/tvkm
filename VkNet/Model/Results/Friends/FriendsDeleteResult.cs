...
public class FriendsDeleteResult
{
    ...
    public static FriendsDeleteResult FromJson(VkResponse response)
    {
        ...
        {
            Success = response["success"], FriendDeleted = response["friend_deleted"],
            OutRequestDeleted = response["out_request_deleted"], InRequestDeleted = response["in_request_deleted"],
