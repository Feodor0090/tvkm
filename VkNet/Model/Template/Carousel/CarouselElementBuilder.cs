...
public class CarouselElementBuilder : ICarouselElementBuilder
{
    ...
    private const string ButtonPayloadLengthExceptionTemplate =
        "Для кнопки payload должен быть максимум 255 символов: {0}";
    ...
    /// <inheritdoc />
    public ICarouselElementBuilder AddButton(string label, string extra, KeyboardButtonColor color = default,
        string type = null)
    {
        ...
        if (Buttons.Count >= 3) throw new TooMuchButtonsException(TooMuchButtonsExceptionTemplate);
