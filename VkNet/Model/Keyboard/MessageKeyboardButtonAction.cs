...
public class MessageKeyboardButtonAction
{
	...
	///         <item>
	///             <term>
	///                 <see cref="KeyboardButtonActionType.VkApp" />
	///             </term>
	///             <description>хэш для навигации в приложении, будет передан в строке параметров запуска после символа #</description>
	///         </item>
	///         <item>
	///             <term>
	///                 <see cref="KeyboardButtonActionType.VkPay" />
	///             </term>
	///             <description>
	///                 строка, содержащая параметры платежа VK Pay и идентификатор приложения в параметре <c>aid</c>,
	///                 разделенные &amp;.
	///             </description>
	///         </item>
	///         <item>
	///             <term>
	///                 <see cref="KeyboardButtonActionType.Location" />
	///             </term>
	///             <description>По нажатию отправляет местоположение в диалог с ботом/беседу.</description>
	///         </item>
	///         <item>
	///             <term>
	///                 <see cref="KeyboardButtonActionType.OpenLink" />
	///             </term>
