...
public class LeadFormsCreateParams
{
	...
	///     Используйте значение поля <c>photo</c>, которое возвращает метод <c>leadForms.get</c> или <c>leadForms.list</c>.
	///     строка
	/// </summary>
	[JsonProperty("photo")]
	...
	/// <summary>
	///     Передайте список email-адресов, разделённых запятой, на которые будут отправлены оповещения о заполнении
	///     пользователями формы.
	...
	/// <summary>
	///     Передайте список идентификаторов пользователей, которым будут отправлены оповещения о заполнении пользователями
	///     формы.
