...
public class GetTargetingStatsParams
{
	...
	/// <summary>
	///     Сериализованный JSON-объект, описывающий параметры таргетинга. Описание объекта criteria см. ниже. Игнорируется,
	///     если задан параметр ad_id. строка
	/// </summary>
	...
	/// <summary>
	///     Идентификатор рекламного объявления, чьи параметры таргетинга требуется анализировать. Если задан этот параметр,
	///     criteria игнорируется. целое число
	/// </summary>
	[JsonProperty("ad_id")]
