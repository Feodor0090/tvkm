...
public class UpdateTargetGroupParams
{
	...
	///     новых аудиторий его следует опускать, иначе будет возвращена ошибка. строка
	/// </summary>
	[JsonProperty("domain")]
	...
	/// <summary>
	///     Закодированный в JSON массив правил, в соответствии с которыми будет пополняться аудитория из пикселя. Подробнее
	///     см. документацию метода ads.createTargetGroup. данные в формате JSON
	/// </summary>
