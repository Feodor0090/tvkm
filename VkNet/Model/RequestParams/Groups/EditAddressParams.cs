...
public class EditAddressParams
{
	...
	/// </summary>
	/// <remarks>
	///     Для получения можно использовать <see cref="IDatabaseCategory" />.
	///     <see cref="IDatabaseCategory.GetCountriesAsync" /> положительное число, минимальное значение 0
	/// </remarks>
	...
	/// </summary>
	/// <remarks>
	///     Для получения можно использовать <see cref="IDatabaseCategory" />.<see cref="IDatabaseCategory.GetCitiesAsync" />
	...
	/// <remarks>
	///     Для получения можно использовать <see cref="IDatabaseCategory" />.
	///     <see cref="IDatabaseCategory.GetMetroStationsAsync" /> положительное число, минимальное значение 0
	/// </remarks>
	[JsonProperty("metro_id")]
    public ulong MetroId { get; set; }

	/// <summary>
	///     Географическая широта отметки, заданная в градусах (от -90 до 90). дробное число, минимальное значение -90,
	...
	/// <summary>
	///     Географическая долгота отметки, заданная в градусах (от -180 до 180). дробное число, минимальное значение -180,
	...
	///     Для получения информации об остальных адресах нужно перейти к списку адресов. флаг, может принимать значения 1 или
	///     0
	/// </summary>
