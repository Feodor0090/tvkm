...
public class AddAddressParams
{
	...
	///     <see cref="IDatabaseCategory.GetCountriesAsync" /> положительное число,
	...
	/// <remarks>
	///     Для получения можно использовать <see cref="IDatabaseCategory" />.
	///     <see cref="IDatabaseCategory.GetMetroStationsAsync" />
	...
	///     Ключ по дню означает, что день рабочий. open_time, close_time - начало и конец рабочего дня. break_open_time,
	///     break_close_time —  время перерыва.
	/// </summary>
