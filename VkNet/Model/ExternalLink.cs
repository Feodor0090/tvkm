...
public class ExternalLink
{
    ...
    public static ExternalLink FromJson(VkResponse response)
    {
        ...
        {
            Id = response["id"], Uri = response["url"], Name = response["name"] ?? response["title"],
            Description = response["desc"] ?? response["description"], Photo50 = response["photo_50"],
            Photo100 = response["photo_100"], EditTitle = response["edit_title"],
