...
public class Message : MediaAttachment
{
    ...
    {
        if (response.ContainsKey("message")) response = response["message"];
    ...
    ///     <remarks>
    ///         Присутствует только в сообщениях с <b>прослушанным</b> <see cref="AudioMessage">голосовым Attachment</see>. Во
    ///         всех остальных случаях - <c>null</c>.
    ///     </remarks>
    ///     >
    /// </summary>
