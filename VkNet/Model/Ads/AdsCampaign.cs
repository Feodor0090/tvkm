...
public class AdsCampaign
{
    ...
    public static AdsCampaign FromJson(VkResponse response)
    {
        ...
        {
            Id = response["id"], Type = response["type"], Name = response["name"], Status = response["status"],
            DayLimit = response["day_limit"], AllLimit = response["all_limit"], StartTime = response["start_time"],
