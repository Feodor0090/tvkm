...
public class MessageActionObject
{
	...
	///     Идентификатор пользователя, который закрепил/открепил сообщение для action = chat_pin_message или
	///     chat_unpin_message.
	/// </summary>
	...
	/// <summary>
	///     Id сообщения, с которым произведено действие (для служебных сообщений с type = chat_pin_message или
	///     chat_unpin_message).
	/// </summary>
	...
	/// <summary>
	///     Email, который пригласили или исключили (для служебных сообщений с type = chat_invite_user или chat_kick_user и
	///     отрицательным member_id).
	/// </summary>
	[JsonProperty("email")]
