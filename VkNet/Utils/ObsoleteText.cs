...
public static class ObsoleteText
{
	...
	public const string Browser =
        "Интерфейс был разделен на " + nameof(IImplicitFlow) + " и " + nameof(INeedValidationHandler);
	...
	/// <summary>
	///     Данный метод устарел, используйте перегрузку класса <see cref="INeedValidationHandler" />.
	///     <see cref="INeedValidationHandler.Validate(string)" />
	/// </summary>
	...
	public const string MessageMarkAsImportantDialog =
        Deprecated + nameof(IMessagesCategory.MarkAsImportantConversation);
