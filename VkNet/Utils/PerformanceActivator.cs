...
{
	/// <inheritdoc
	///     cref="CreateInstance{TResult}(System.Func{System.Reflection.ConstructorInfo,bool}(System.Reflection.ConstructorInfo),object[])" />
	...
	/// <typeparam name="TResult">Возвращаемый тип</typeparam>
	/// <returns>Экземпляр класса <typeparamref name="TResult" /></returns>
	internal static TResult CreateInstance<TResult>(Type obj, Func<ConstructorInfo, bool> constructorFilter,
        params object[] args)
        where TResult : class
    {
