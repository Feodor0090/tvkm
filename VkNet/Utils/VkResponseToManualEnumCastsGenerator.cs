...
public partial class VkResponse
{
    ...
    {
        if (response == null) return DocumentTypeEnum.Unknown;

        return Utilities.EnumFrom<DocumentTypeEnum>(response);
    }
    ...
    {
        if (response == null) return AddFriendStatus.Unknown;
    ...
    {
        if (response == null) return WallType.Off;
    ...
    {
        if (response == null) return AgeLimit.Withoutlimit;
    ...
    {
        if (response == null) return MemberStatus.Invited;
    ...
    {
        if (response == null) return Attitude.Unknown;
    ...
    {
        if (response == null) return BanReason.Other;
    ...
    {
        if (response == null) return BirthdayVisibility.Invisible;
    ...
    {
        if (response == null || response["success"] == 0) return DeleteFriendStatus.Unknown;
    ...
    {
        if (response == null) return FriendStatus.NotFriend;
    ...
    {
        if (response == null) return GiftPrivacy.NameHideMessageUser;
    ...
    {
        if (response == null) return GroupAccess.Open;
    ...
    {
        if (response == null) return LeaderboardTypes.NotSupported;
    ...
    {
        if (response == null) return LifeMain.Unknown;
    ...
    {
        if (response == null) return MainSection.NoSection;
    ...
    {
        if (response == null) return MarketCurrencyId.Rub;
    ...
    {
        if (response == null) return PeopleMain.Unknown;
    ...
    {
        if (response == null) return PoliticalPreferences.Unknown;
    ...
    {
        if (response == null) return ProductAvailability.Unavailable;
    ...
    {
        if (response == null) return ProductSort.UserSort;
    ...
    {
        if (response == null) return RelationType.Unknown;
    ...
    {
        if (response == null) return ReportReason.Spam;
    ...
    {
        if (response == null) return Sex.Unknown;
    ...
    {
        if (response == null) return WallContentAccess.Off;
    ...
    {
        if (response == null) return AccountStatus.Inactive;
    ...
    {
        if (response == null) return CampaignStatus.Stopped;
    ...
    {
        if (response == null) return AutoBidding.Off;
    ...
    {
        if (response == null) return AdAgeRestriction.ZeroPlus;
    ...
    {
        if (response == null) return AdFormat.Public;
    ...
    {
        if (response == null) return CostType.Cpc;
    ...
    {
        if (response == null) return AdStatus.Stopped;
    ...
    {
        if (response == null) return RepeatVideo.NotRepeat;
    ...
    {
        if (response == null) return GoalType.Cpc;
    ...
    {
        if (response == null) return AdIcon.AdIconNo;
