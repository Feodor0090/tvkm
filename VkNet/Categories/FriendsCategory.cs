...
public partial class FriendsCategory : IFriendsCategory
{
    ...
    public FriendOnline GetOnline(FriendsGetOnlineParams @params)
    {
        ...
        {
            {"user_id", @params.UserId}, {"list_id", @params.ListId}, {"online_mobile", @params.OnlineMobile},
            {"order", @params.Order}, {"count", @params.Count}, {"offset", @params.Offset}
        });
    ...
    {
        if (@params.TargetUid.HasValue) @params.TargetUids = new[] {@params.TargetUid.Value};
    ...
    public AddFriendStatus Add(long userId, string text = "", bool? follow = null, long? captchaSid = null,
    ...
    public GetRequestsResult GetRequests(FriendsGetRequestsParams @params)
    {
        ...
        {
            {"offset", @params.Offset}, {"count", @params.Count}, {"extended", @params.Extended},
            {"need_mutual", @params.NeedMutual}, {"out", @params.Out}, {"sort", @params.Sort},
            {"suggested", @params.Suggested}, {"need_viewed", @params.NeedViewed}
        });
    }
    ...
    public VkCollection<User> Search(FriendsSearchParams @params)
    {
        ...
        {
            {"user_id", @params.UserId}, {"q", @params.Query}, {"fields", @params.Fields},
            {"name_case", @params.NameCase}, {"offset", @params.Offset}, {"count", @params.Count}
