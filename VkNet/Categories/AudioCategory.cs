...
public partial class AudioCategory : IAudioCategory
{
    ...
    /// <inheritdoc />
    public AudioPlaylist CreatePlaylist(long ownerId, string title, string description = null,
    ...
    public long Edit(AudioEditParams @params)
    {
        ...
        {
            {"owner_id", @params.OwnerId}, {"audio_id", @params.AudioId}, {"artist", @params.Artist},
            {"title", @params.Title}, {"text", @params.Text}, {"genre_id", @params.GenreId},
            {"no_search", @params.NoSearch}
        });
    }

    /// <inheritdoc />
    public bool EditPlaylist(long ownerId, int playlistId, string title, string description = null,
        IEnumerable<string> audioIds = null)
    {
        var parameters = new VkParameters
        {
    ...
    /// <inheritdoc />
    public IEnumerable<Audio> GetPopular(bool onlyEng = false, AudioGenre? genre = null, uint? count = null,
        uint? offset = null)
    {
        var parameters = new VkParameters
        {
    ...
    public VkCollection<Audio> Search(AudioSearchParams @params)
    {
        ...
        {
            {"q", @params.Query}, {"auto_complete", @params.Autocomplete}, {"sort", @params.Sort},
            {"lyrics", @params.Lyrics}, {"performer_only", @params.PerformerOnly}, {"search_own", @params.SearchOwn},
