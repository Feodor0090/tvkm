...
public partial class NewsFeedCategory : INewsFeedCategory
{
        ...
        , long? count = null)
    {
        ...
        if (count <= 50) parameters.Add("count", count);
    ...
    public NewsSearchResult Search(NewsFeedSearchParams @params)
    {
        ...
        if (@params.Count <= 200) parameters.Add("count", @params.Count);
    ...
    /// <inheritdoc />
    public NewsSuggestions GetSuggestedSources(long? offset = null, long? count = null, bool? shuffle = null,
        UsersFields fields = null)
    {
        ...
        if (count <= 1000) parameters.Add("count", count);
