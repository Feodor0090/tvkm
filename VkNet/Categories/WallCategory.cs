...
public partial class WallCategory : IWallCategory
{
        ...
        , bool skipAuthorization = false)
    {
        ...
        if (!posts.Any()) throw new ArgumentException("Posts collection was empty.", nameof(posts));
    ...
    public WallGetObject Search(WallSearchParams @params, bool skipAuthorization = false)
    {
        ...
        {
            {"owner_id", @params.OwnerId}, {"domain", @params.Domain}, {"query", @params.Query},
            {"owners_only", @params.OwnersOnly}, {"count", @params.Count}, {"offset", @params.Offset},
            {"extended", @params.Extended}, {"fields", @params.Fields}
        }, skipAuthorization);
    }
    ...
    public bool EditAdsStealth(EditAdsStealthParams @params)
    {
        ...
        {
            {"owner_id", @params.OwnerId}, {"post_id", @params.PostId}, {"message", @params.Message},
            {"attachments", @params.Attachments}, {"signed", @params.Signed}, {"lat", @params.Lat},
            {"long", @params.Long}, {"place_id", @params.PlaceId}, {"link_title", @params.LinkTitle},
    ...
    public long PostAdsStealth(PostAdsStealthParams @params)
    {
        ...
        {
            {"owner_id", @params.OwnerId}, {"message", @params.Message}, {"attachments", @params.Attachments},
            {"signed", @params.Signed}, {"lat", @params.Lat}, {"long", @params.Long}, {"place_id", @params.PlaceId},
            {"link_title", @params.LinkTitle}, {"link_image", @params.LinkImage}, {"guid", @params.Guid},
