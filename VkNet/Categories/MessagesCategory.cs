...
public partial class MessagesCategory : IMessagesCategory
{
    ...
    public long Send(MessagesSendParams @params)
    {
        ...
        return _vk.Call("messages.send",
            new VkParameters
            {
                ...
                {
                    "content_source",
                    @params.ContentSource != null ? JsonConvert.SerializeObject(@params.ContentSource) : ""
                },
                {"group_id", @params.GroupId},
    ...
    /// <inheritdoc />
    public ConversationResult GetConversationsById(IEnumerable<long> peerIds, IEnumerable<string> fields = null,
        bool? extended = null,
        ulong? groupId = null)
    {
    ...
    /// <inheritdoc />
    public GetConversationMembersResult GetConversationMembers(long peerId, IEnumerable<string> fields = null,
        ulong? groupId = null)
    {
    ...
    {
        return DeleteConversation(userId, peerId);
    }
    ...
    public bool SetActivity(string userId, MessageActivityType type, long? peerId = null, ulong? groupId = null)
    {
        ...
        if (peerId is not null && groupId is not null)
            throw new VkApiException(
                "This method doesn't accept 'peerId' and 'groupId' being specified simultaneously");
        ...
        NameCase nameCase = null)
    {
        ...
        if (isNoEmpty) throw new ArgumentException("At least one chat ID must be defined", nameof(chatIds));
    ...
    {
        if (string.IsNullOrEmpty(title)) throw new ArgumentException("Title can not be empty or null.", nameof(title));
    ...
    private IDictionary<ulong, bool> Delete(IEnumerable<ulong> messageIds,
        ...
        bool? deleteForAll = null)
    {
        ...
        if (ids.Count == 0) throw new ArgumentException("Parameter Ids has no elements.", nameof(messageIds));
