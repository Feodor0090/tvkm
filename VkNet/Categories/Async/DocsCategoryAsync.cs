...
public partial class DocsCategory
{
    ...
    {
        return TypeHelper.TryInvokeMethodAsync(() => GetById(docs));
    }

    /// <inheritdoc />
    public Task<UploadServerInfo> GetUploadServerAsync(long? groupId = null)
    {
        return TypeHelper.TryInvokeMethodAsync(() => GetUploadServer(groupId));
    }
    ...
    {
        return TypeHelper.TryInvokeMethodAsync(() => Save(file, title, tags));
    }
    ...
    {
        return TypeHelper.TryInvokeMethodAsync(() => Delete(ownerId, docId));
    }

    /// <inheritdoc />
    public Task<long> AddAsync(long ownerId, long docId, string accessKey = null)
    {
        return TypeHelper.TryInvokeMethodAsync(() => Add(ownerId, docId, accessKey));
    }
    ...
    {
        return TypeHelper.TryInvokeMethodAsync(() => GetTypes(ownerId));
    }

    /// <inheritdoc />
    public Task<VkCollection<Document>> SearchAsync(string query, bool searchOwn, long? count = null,
        long? offset = null)
    {
        return TypeHelper.TryInvokeMethodAsync(() =>
    ...
    {
        return TypeHelper.TryInvokeMethodAsync(() => GetMessagesUploadServer(groupId, type));
    }
}