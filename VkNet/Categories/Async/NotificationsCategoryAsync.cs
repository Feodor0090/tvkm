...
public partial class NotificationsCategory
{
    ...
    {
        return TypeHelper.TryInvokeMethodAsync(() => Get(count, startFrom, filters, startTime, endTime));
    }
    ...
    {
        return TypeHelper.TryInvokeMethodAsync(MarkAsViewed);
    }

    /// <inheritdoc />
    public Task<IEnumerable<NotificationsSendMessageResult>> SendMessageAsync(
        NotificationsSendMessageParams sendMessageParams,
