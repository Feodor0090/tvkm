...
public partial class GroupsCategory
{
    ...
    /// <inheritdoc />
    public Task<ReadOnlyCollection<Group>> GetByIdAsync(IEnumerable<string> groupIds, string groupId,
        GroupsFields fields,
    ...
    /// <inheritdoc />
    public Task<ReadOnlyCollection<GroupMember>> IsMemberAsync(string groupId, long? userId, IEnumerable<long> userIds,
        bool? extended,
        bool skipAuthorization = false)
    {
    ...
    {
        return TypeHelper.TryInvokeMethodAsync(() => GetSettings(groupId));
    }
    ...
    /// <inheritdoc />
    public Task<Group> CreateAsync(string title, string description = null, GroupType type = null,
    ...
    /// <inheritdoc />
    public Task<VkCollection<User>> GetRequestsAsync(long groupId, long? offset = null, long? count = null,
    ...
    {
        return TypeHelper.TryInvokeMethodAsync(() => GetCallbackConfirmationCode(groupId));
    }
