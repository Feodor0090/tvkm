...
public class MessageAction : SafetyEnum<MessageAction>
{
	...
	/// </summary>
	public static readonly MessageAction ChatInviteUserByLink = RegisterPossibleValue("chat_invite_user_by_link");
    ...
    {
        return response?.HasToken() != null ? FromJson(response) : null;
    }
}