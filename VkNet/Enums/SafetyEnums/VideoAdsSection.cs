...
public class VideoAdsSection : SafetyEnum<VideoAdsSection>
{
	...
	///     </remarks>
	/// </summary>
	public static readonly VideoAdsSection Preroll = RegisterPossibleValue("preroll");
	...
	///     </remarks>
	/// </summary>
	public static readonly VideoAdsSection Midroll = RegisterPossibleValue("midroll");
	...
	///     </remarks>
	/// </summary>
	public static readonly VideoAdsSection Postroll = RegisterPossibleValue("postroll");
}