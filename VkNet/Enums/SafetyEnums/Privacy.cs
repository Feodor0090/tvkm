...
public sealed class Privacy : SafetyEnum<Privacy>
{
	...
	/// </summary>
	[DefaultValue] public static readonly Privacy All = RegisterPossibleValue("all");
	...
	public new static Privacy FromJson(VkResponse response)
    {
        switch (response.ToString())
        {
...

            {
                ...
                if (input.StartsWith("list")) return AvailableForList(id);

                if (input.StartsWith("-list")) return UnAvailableForList(id);
