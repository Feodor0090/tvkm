...
public class AudioCatalogSourceType : SafetyEnum<AudioCatalogSourceType>
{
	...
	/// </summary>
	public static readonly AudioCatalogSourceType RecomsTopAudiosGlobal =
        RegisterPossibleValue("recoms_top_audios_global");
	...
	/// </summary>
	public static readonly AudioCatalogSourceType RecomsRecentRecommendation =
        RegisterPossibleValue("recoms_recent_recommendation");
